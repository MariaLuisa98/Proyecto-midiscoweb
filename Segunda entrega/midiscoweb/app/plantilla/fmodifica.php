...
Plan <select name="plan">
	<option value="0" <?= ($plan == "0")?"selected":""  ?> >BÃ¡sico</option>
	<option value="1" <?= ($plan == "1")?"selected":""  ?> >Profesional</option>
	<option value="2" <?= ($plan == "2")?"selected":""  ?> >Premium</option>
    <option value="3" <?= ($plan == "3")?"selected":""  ?> >MÃ¡ster</option>
</select><br>
	<input type="submit" value=" Guardar ">
	<input type="submit" value="Cancelar" size="10" onclick="javascript:window.location='index.php'" >
</form>
<?php 
